...
namespace Alpha.DataAccess.Migrations
{
    ...
    [Migration("20230913120824_addclinet")]
    partial class addclinet
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Alpha.Models.Models.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Alpha.Models.Models.DetailsSection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("detailsSections");

                    b.HasData(
                        new
                        {
                            Id = 1,
                            Description = "We worked long and hard to create the glasses of our dreams, but before launching, we decided to test it out on two crowdfunding platforms: Kickstarter and Indiegogo.!",
                            Image = " ",
                            Title = " Our product will amaze you"
                        });
                });

            modelBuilder.Entity("Alpha.Models.Models.Feature", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Description = "The best high-quality lenses are made from durable materials and use a series of treatments to help resist scratching and damage, while providing protection from UV rays. Prescription lenses are the best lenses for people who need one kind of vision correction that can be addressed with a single pair of lenses..",
                            Icon = "<i class=\"far fa-heart fs-3\"></i>",
                            Title = " Quality"
                        });
                });

            modelBuilder.Entity("Alpha.Models.Models.Header", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Alpha.Models.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Alpha.Models.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Alpha.Models.Models.OtherFeature", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Alpha.Models.Models.ProductImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Alpha.Models.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Alpha.Models.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Alpha.Models.Models.OrderDetail", b =>
                {
                    b.HasOne("Alpha.Models.Models.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Alpha.Models.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("Alpha.Models.Models.OrderHeader", b =>
                {
                    b.HasOne("Alpha.Models.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Alpha.Models.Models.ApplicationUser", b =>
                {
                    b.HasOne("Alpha.Models.Models.Company", "Company")
                        .WithMany()
